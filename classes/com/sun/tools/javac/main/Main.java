...
public class Main {
	...
	/**
	 * Process command line arguments: store all command line options in `options'
	 * table and return all source filenames.
	 * 
	...
	public int compile(String[] args, Context context, List<JavaFileObject> fileObjects,
		...
		/*
		 * TODO: Logic below about what is an acceptable command line should be updated
		 * to take annotation processing semantics into account.
		 */
		try {
